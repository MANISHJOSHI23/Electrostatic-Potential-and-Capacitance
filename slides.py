...
class Dielectric(Slide):
    def construct(self):
        ...
        steps4 = ItemList(Item(r"In an external electric field, the positive and negative charges of a non- polar molecule are displaced in opposite directions ",pw="7 cm"),
                          Item(r"The non-polar molecule thus develops an induced dipole moment. The dielectric is said to be polarised by the external field.",pw="7 cm",color=YELLOW_D),
                          Item(r"Linear  isotropic dielectrics :",r" Dielectrics for which the induced dipole moment is in the direction of the field and is proportional to the field strength",pw="7 cm"),
                          buff=0.55).next_to(title,DOWN).to_edge(LEFT,buff=0.3)
        
        d_img = Rectangle(height=3,width=2.4,fill_opacity=0.3).set_color_by_gradient(BLUE,BLUE_E)
        Ein = Tex(r"$\vec{E}_{\text{net}}=0$ \\ $\vec{p}_{\text{net}}=0$",font_size=35,color=YELLOW).next_to(d_img,RIGHT)
        ...
        d_img = Rectangle(height=3,width=2.4,fill_opacity=0.3).set_color_by_gradient(BLUE,BLUE_E)
        E_net = Tex(r"$\vec{E}_{\text{net}}\neq0$ \\ $\vec{p}_{\text{net}}\neq0$",font_size=35,color=YELLOW).next_to(d_img,RIGHT)
        d_lbl = Tex(r"In the presence of\\ external field",font_size=35).next_to(d_img,DOWN,buff=-0.35).next_to(Ein,DOWN)
        ...
        Ein = MyLabeledArrow(label=Tex(r"$\vec{E}_{\text{ind}}$",font_size=30),pos=0.55*RIGHT,start=d_img.get_top()+1.2*DOWN,end=d_img.get_top()+1.2*DOWN+0.65*LEFT,tip_length=0.2,color=PINK)
        ...
        anm3 = [Write(title),Write(img1.next_to(steps4[0],RIGHT).align_to(title,UP).to_edge(RIGHT)),Succession(Write(steps4[0]),Write(img2.next_to(img1,DOWN,buff=0.1))),Write(steps4[1]),Write(steps4[2][0].set_color(GOLD)),Write(steps4[2][1]),FadeOut(steps4,title,img1,img2)]
        for item in anm3:
            self.play(item)
            self.next_slide()
        ...
        d_img = Rectangle(height=3,width=2.4,fill_opacity=0.3).set_color_by_gradient(BLUE,BLUE_E)
        E_net = Tex(r"$\vec{E}_{\text{net}}=0$ \\ $\vec{p}_{\text{net}}=0$",font_size=35,color=YELLOW).next_to(d_img,RIGHT)
        d_lbl = Tex(r"If $E_0=0$",font_size=35).next_to(d_img,DOWN,buff=-0.35).next_to(E_net,UP)
        img5 = VGroup(d_img.copy())
        Ein = MyLabeledArrow(label=Tex(r"$\vec{E}_{\text{ind}}$",font_size=30),pos=0.55*RIGHT,start=d_img.get_top()+1.2*DOWN,end=d_img.get_top()+1.2*DOWN+0.65*LEFT,tip_length=0.2,color=PINK)
        img6 = VGroup(d_img)
        for i in [1.2, 0.6, 0, -0.6, -1.2]:
            for j in [0.4, 1.2, 2]:
                ...
                m = Tex(r"$-$",font_size=20).move_to(c.get_left()+0.1*RIGHT)
                p = Tex(r"$+$",font_size=20).move_to(c.get_right()+0.1*LEFT)
                img5.add(VGroup(c.copy(),p.copy(),m.copy()).rotate(random.randrange(0,180,20)*DEGREES))
                img6.add(VGroup(c,p,m).rotate(random.randrange(0,20,2)*DEGREES))

        dline1 = DashedLine(start=d_img.get_top(),end=d_img.get_bottom(),color=GREEN_B).move_to(d_img.get_left()+0.35*RIGHT)
        dline2 = DashedLine(start=d_img.get_top(),end=d_img.get_bottom(),color=GREEN_B).move_to(d_img.get_right()+0.35*LEFT)
        spn = Tex(r"$-\sigma_p$",font_size=30).move_to(d_img.get_left()+0.27*LEFT+DOWN)
        spp = Tex(r"$+\sigma_p$",font_size=30).move_to(d_img.get_right()+0.27*RIGHT+DOWN)
        
        img5.add(d_lbl,E_net).next_to(steps5[0],RIGHT).align_to(title,UP).to_edge(RIGHT)
        E_net2 = Tex(r"$\vec{E}_{\text{net}}\neq0$ \\ $\vec{p}_{\text{net}}\neq 0$",font_size=35,color=YELLOW).next_to(img6,RIGHT)
        Eo = MyLabeledArrow(label=Tex(r"$\vec{E}_{0}$",font_size=30),pos=0.25*UP,start=img6.get_right()+0.25*UP+0.5*LEFT,end=img6.get_right()+0.25*UP+0.5*RIGHT,tip_length=0.2,color=GREEN_D).next_to(E_net2,UP)
        img6.add(Eo,E_net2,Ein,dline1,dline2,spn,spp).next_to(img5,DOWN)
        img7 = img5.copy().next_to(img5,DOWN)

        anm4 = [Write(title), Succession(Write(steps5[0]),Write(img5)), Succession(Write(steps5[1]),Write(img7.next_to(img5,DOWN))),Succession(ReplacementTransform(img7,img6[0:-5]),Write(VGroup(Ein,dline1,dline2,spn,spp))),Write(steps5[2]),FadeOut(steps5,img5,title)]
        for item in anm4:
            self.play(item)
            self.next_slide()

        title = Tex(r"Polarisation $(\vec{P})$ :",font_size=35,color=ORANGE).next_to(Intro_title,DOWN).to_edge(LEFT,buff=0.1)
        steps6 = ItemList(Item(r"A dielectric developes a net dipole moment $(\vec{p}_{\text{net}})$ in the presence of external field $(\vec{E}_0)$.",pw="13 cm"),
                          Item(r"The dipole moment per unit volume is called Polarisation $(\vec{P})$",pw="13 cm",color=YELLOW_D),
                          Item(r"$\vec{P}\propto \vec{E}$ ",pw="8 cm",dot=False),
                          Item(r"$\vec{P}= \epsilon_0 \chi_e\vec{E}$ ",pw="8 cm",color=RED,dot=False),
                          Item(r"where $\chi_e$ is a constant characteristic of the dielectric and is known as the ", r"\textbf{electric susceptibility}", r" of the dielectric medium.",pw="7 cm",color=YELLOW_D),
                          buff=0.55).next_to(title,DOWN).to_edge(LEFT,buff=0.3)
        

        steps6[4][1].set_color(BLUE)
        
        anm5 = [Write(title),Write(steps6[0]),Write(steps6[1]),Write(steps6[2]),Write(steps6[3]),Write(steps6[4])]
        for item in anm5:
            self.play(item)
            self.next_slide()
...
class PPCapacitor(ThreeDScene,Slide):
    def construct(self):
        ...
        A = Tex("$A$",font_size=35).move_to(plane.get_center()+1.4*OUT+0.5*DOWN)
        pc = VGroup()
        nc = VGroup()
        E = VGroup()
        for i in range(-4,4):
            for j in range(-4,5):
                ...
                if i%2 == 0 and j%2==0:
                    E.add(Arrow3D(start=i*0.33*UP+j*0.33*IN,end=i*0.33*UP+j*0.33*IN+2*RIGHT,color=RED))
        
        plane2 = VGroup(plane.copy(),nc,density2,A).shift(2*RIGHT)
        ...
        img = VGroup(plane,plane2,density,density2, pc,d,d_lbl,E).next_to(Intro_title,DOWN).shift(1.5*RIGHT+0.2*DOWN)
        ...
        steps1 = ItemList(Item(r"A parallel plate capacitor consist of two large plane parallel conducting plates each of Area (A) and separated by a small distance (d)",pw="13 cm",color=YELLOW_D),
                          ...
                          Item(r"$C=\dfrac{Q}{V}=$ ",r" $\dfrac{Q\epsilon_0 A}{Qd}=$ ",r" $\dfrac{\epsilon_0 A}{d}$",pw="13 cm",color=YELLOW_D),
        ...
        self.add_fixed_orientation_mobjects(density,density2,d_lbl,A)
        self.play(FadeOut(steps1))
        self.add(img)
        self.wait(2)
        anm = (Write(steps1[0]),Write(steps1[1]),Write(steps1[2]),Write(steps1[3][0]),Write(steps1[3][1]),Write(steps1[4],Write(steps1[5])),Write(steps1[6][0]),Write(steps1[6][1]),Write(steps1[6][2]))
